...
class UserProfile(models.Model):
    ...
    phone_number = PhoneNumberField(blank=True, null=True, db_column='phone_number')
    location = models.CharField(max_length=50, blank= True, null = True, db_column='location')
